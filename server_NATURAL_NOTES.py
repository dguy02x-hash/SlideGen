...
# @subscription_required  # REMOVED FOR TESTING
def generate_notes():
    """Generate speaker notes - DISABLED - returns empty notes"""
    try:
        # SPEAKER NOTES DISABLED - returning empty response
        return jsonify({
            'notes': '',
            'structure_used': 'disabled',
...
if __name__ == '__main__':
    ...
    print("✓ Speaker notes DISABLED per user request")
    print("✓ Slide generation working normally")
