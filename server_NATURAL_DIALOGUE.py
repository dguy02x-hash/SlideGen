...
✓ NEW: Custom Style Generation - AI interprets natural language prompts to create custom presentation themes
...
def clean_meta_instructions(notes_text):
    ...
    meta_patterns = [
        ...
        r"[Ll]et me (walk you through|explain|tell you|show you)\s+",
...
# @subscription_required  # REMOVED FOR TESTING
def generate_notes():
    """Generate speaker notes as natural dialogue expanding on slide points"""
    try:
        user_id = session['user_id']
        ...
        if style == "Concise":
            prompt = f"""Write natural dialogue for a presenter explaining these slide points. Write like a person talking to an audience.
...
Write 4-6 sentences of natural dialogue that explains these points. Include transition words between ideas. Add specific details, examples, or data from the research.
...
Just write natural dialogue explaining the points:"""
        
        elif style == "Full Explanation":
            prompt = f"""Write natural dialogue for a presenter explaining these slide points in depth. Write like a knowledgeable person talking to an engaged audience.
...
Write 10-14 sentences of natural dialogue that thoroughly explains these points. Include transition words and connect ideas smoothly. Add specific details, statistics, examples, and context from the research.
...
Use natural transitions like "This meant that...", "At the same time...", "The result was...", "Following this..."
...
Just write natural dialogue:"""
        
        else:  # Detailed
            prompt = f"""Write natural dialogue for a presenter explaining these slide points. Write like a person talking to an audience about the topic.
...
Write 7-10 sentences of natural dialogue that explains these points clearly. Include transition words between ideas. Add specific details, examples, or data from the research.
...
Use natural transitions like "This meant that...", "As a result...", "Additionally...", "Following this...", "At the same time..."
...
- "Make sure to note"
- "The key thing is"
- Any instructions or directions to the speaker
...
if __name__ == '__main__':
    ...
    print("✓ Natural dialogue speaker notes with web research")
    print("✓ Expands on slide points without meta-instructions")
    print("✓ NEW: AI-powered custom style generation from prompts")
    print("✓ All speaker notes AI-generated from key points")
