...
def generate_notes():
    ...
    try:
        ...
        # STEP 3: Generate speaker notes as bullet points expanding on the slide sentence
        if style == "Concise":
            prompt = f"""The slide shows this sentence:
"{slide_text}"

Write 3-4 main idea bullet points that expand on this sentence. Each bullet should explain one aspect in detail.

ADDITIONAL CONTEXT:
{web_context}

INSTRUCTIONS:
1. Write 3-4 bullet points (full sentences)
2. Each bullet expands on a different aspect of the slide sentence
3. Include specific details, data, or examples
4. Vary how each bullet starts
5. Make them informative like this example:

EXAMPLE - If slide says "In 1957, the Soviet Union launched Sputnik 1, marking the start of the Space Age"
Bullet 1: "The launch shocked the world because it proved humans could send objects beyond Earth's atmosphere"
Bullet 2: "Sputnik triggered intense scientific and military competition between the U.S. and USSR, creating the Space Race"
Bullet 3: "It spurred major investments in science education in the United States as the country worked to catch up"

Write the bullet points as separate lines starting with "• ":"""
        
        elif style == "Full Explanation":
            prompt = f"""The slide shows this sentence:
"{slide_text}"

Write 6-8 main idea bullet points that thoroughly expand on this sentence.

ADDITIONAL CONTEXT AND DATA:
{web_context}

INSTRUCTIONS:
1. Write 6-8 bullet points (full sentences, 15-25 words each)
2. Each bullet explains a different aspect, adds context, or provides examples
3. Include specific statistics, dates, or real-world examples
4. Use the {structure_type} approach for variety
5. Vary how each bullet starts - don't be repetitive
6. Make them detailed and informative

EXAMPLE FORMAT:
• First main idea with specific context
• Second main idea with relevant data
• Third main idea with an example
...
Write 4-6 main idea bullet points that expand on this sentence with relevant details.

ADDITIONAL CONTEXT AND DATA:
{web_context}

INSTRUCTIONS:
1. Write 4-6 bullet points (full sentences, 12-20 words each)
2. Each bullet should expand on a different aspect of the slide sentence
3. Include specific information, statistics, or examples where relevant
4. Use the {structure_type} approach for variety
5. Vary your sentence openings - don't start multiple bullets the same way
6. Just explain the information - don't give instructions

EXAMPLE - If slide says "Cloud migration delivers measurable operational improvements"
• Organizations report average cost reductions of 32% by eliminating capital expenditure on hardware
• Cloud services achieve 99.99% uptime compared to traditional data center benchmarks of 95%
• Companies can deploy across 25+ regions worldwide, reducing latency for global users
• Migration typically shows ROI within 18 months through combined savings and efficiency gains

Write the bullet points as separate lines starting with "• ":"""
        
        response = call_anthropic(prompt, max_tokens=1500)
        
        # STEP 4: Clean any meta-instructions
        ...
        logger.info(f"Generated web-enhanced bullet-point notes with {structure_type} structure for: {slide_title}")
